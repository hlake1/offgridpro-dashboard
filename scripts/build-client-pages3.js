...
<header class="cl-hero text-white">
  ...
  <div class="max-w-5xl mx-auto px-6 py-14">
    ...
    <div class="flex items-center gap-4 flex-wrap">
      ...
      <span id="ai-badge" class="bg-white/10 border border-white/20 text-white/80 text-[10px] px-2 py-1 rounded-sm uppercase tracking-widest" style="display:none;" title="Narrative copy was polished by AI from the account manager's notes; all figures are computed directly from the entered data.">AI-polished copy</span>
    </div>
...
(function () {
  ...
  function render() {
    ...
    document.getElementById('ai-badge').style.display = s.aiEnhanced ? 'inline-flex' : 'none';

    const insightsSection = document.getElementById('insights-section');
    const insightsList = document.getElementById('insights-list');
    if (Array.isArray(s.insights) && s.insights.length) {
      insightsSection.style.display = 'block';
      insightsList.innerHTML = s.insights.map(i => \`<li>\${esc(i)}</li>\`).join('');
    } else {
...
<style>
  ...
  /* Channel tabs — standard layout, per Rob (matches OffGrid Pro reports) */
  .tab-btn { transition: all 0.18s ease; border-bottom: 2px solid transparent; white-space: nowrap; color: #6b7280; font-weight: 500; }
  .tab-btn.active { color: ${c.c2}; border-bottom-color: ${c.c2}; font-weight: 700; }
  .tab-btn:not(.active):hover { color: ${c.c2}; background: #f6f9fc; }
...
<main class="max-w-5xl mx-auto px-6 py-14 space-y-6">
  ...
  <!-- Channel tabs: Overview → Google Ads → Meta → SEO → Organic Social → Content -->
  <div class="border-b border-gray-200 -mb-px">
    <div class="flex flex-wrap gap-1">
      <button class="tab-btn active px-3 py-2 rounded-t-lg" data-tab="overview">Overview</button>
      <button class="tab-btn px-3 py-2 rounded-t-lg" data-tab="ads">Google Ads</button>
      <button class="tab-btn px-3 py-2 rounded-t-lg" data-tab="meta">Meta</button>
      <button class="tab-btn px-3 py-2 rounded-t-lg" data-tab="seo">SEO</button>
      <button class="tab-btn px-3 py-2 rounded-t-lg" data-tab="social">Organic Social</button>
      <button class="tab-btn px-3 py-2 rounded-t-lg" data-tab="content">Content</button>
    </div>
  </div>

  <div class="tab-panel active space-y-6" data-panel="overview">
    <section class="card p-8">
      <div class="mb-6">
        <p class="text-[11px] uppercase tracking-widest text-gray-500 font-semibold">Overview</p>
  ...
  <div class="tab-panel" data-panel="ads">
    <section class="card p-6">
      <p class="text-[11px] uppercase tracking-widest text-gray-500 font-semibold">Google Ads</p>
      <h3 class="text-lg font-medium text-gray-900 mt-1">Campaign performance</h3>
      <div class="accent-bar w-12 mt-3 mb-4"></div>
      <p class="text-sm text-gray-500 italic">Populates once Google Ads API access is connected via Maton.</p>
    </section>
  </div>

  <div class="tab-panel" data-panel="meta">
    <section class="card p-6">
      <p class="text-[11px] uppercase tracking-widest text-gray-500 font-semibold">Meta</p>
      <h3 class="text-lg font-medium text-gray-900 mt-1">Meta Ads performance</h3>
      <div class="accent-bar w-12 mt-3 mb-4"></div>
      <p class="text-sm text-gray-500 italic">Populates once Meta Ads Manager access is connected. We never fabricate numbers here in the meantime.</p>
    </section>
  </div>
  ...
  <div class="tab-panel" data-panel="social">
    <section class="card p-6">
      <p class="text-[11px] uppercase tracking-widest text-gray-500 font-semibold">Organic Social</p>
      <h3 class="text-lg font-medium text-gray-900 mt-1">Follower growth &amp; engagement</h3>
      <div class="accent-bar w-12 mt-3 mb-4"></div>
      <p class="text-sm text-gray-500 italic">Populates once social account access is connected.</p>
    </section>
  </div>

  <div class="tab-panel" data-panel="content">
    <section class="card p-6">
      <p class="text-[11px] uppercase tracking-widest text-gray-500 font-semibold">Content</p>
      <h3 class="text-lg font-medium text-gray-900 mt-1">Content showcase</h3>
      <div class="accent-bar w-12 mt-3 mb-4"></div>
      <p class="text-sm text-gray-500 italic">Populates once this month's content assets are added.</p>
    </section>
  </div>
